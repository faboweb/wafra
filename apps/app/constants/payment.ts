const paymentMethods = [
  {
    symbol: "USD",
    supportingCountries: ["US", "PR", "VI", "GU", "TC", "MP"],
    logoSymbol: "US",
    name: "US Dollar",
    paymentOptions: [
      {
        ...
        defaultAmount: 300,
        isConverted: true,
        visaPayoutCountries: ["US"],
        mastercardPayoutCountries: ["US"],
  ...
  },
  {
    ...
    paymentOptions: [
      ...
      },
      {
        ...
        defaultAmount: 250,
        isConverted: true,
        visaPayoutCountries: ["GB", "VI", "GU", "PR"],
        mastercardPayoutCountries: ["GB"],
        isPayOutAllowed: true,
        minAmountForPayOut: 8,
        maxAmountForPayOut: 19363,
        defaultAmountForPayOut: 400,
    ...
    paymentOptions: [
      {
        ...
        isConverted: true,
        isPayOutAllowed: false,
        minAmountForPayOut: 871,
        maxAmountForPayOut: 2177763,
        defaultAmountForPayOut: 43550,
      },
      {
        name: "UPI",
        id: "inr_upi",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 250,
        isConverted: true,
        visaPayoutCountries: ["CH", "LI"],
        mastercardPayoutCountries: ["LI"],
        isPayOutAllowed: true,
        minAmountForPayOut: 9,
        maxAmountForPayOut: 22021,
        defaultAmountForPayOut: 450,
      },
      {
        name: "Apple Pay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 3050,
        isConverted: true,
        visaPayoutCountries: ["SE"],
        mastercardPayoutCountries: ["SE"],
        isPayOutAllowed: true,
        minAmountForPayOut: 101,
        maxAmountForPayOut: 252160,
        defaultAmountForPayOut: 5050,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 1150,
        isConverted: true,
        visaPayoutCountries: ["PL"],
        mastercardPayoutCountries: ["PL"],
        isPayOutAllowed: true,
        minAmountForPayOut: 38,
        maxAmountForPayOut: 96240,
        defaultAmountForPayOut: 1950,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 3250,
        isConverted: true,
        visaPayoutCountries: ["SJ", "NO"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 109,
        maxAmountForPayOut: 271498,
        defaultAmountForPayOut: 5450,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 2050,
        isConverted: true,
        visaPayoutCountries: ["FO", "GL", "DK"],
        mastercardPayoutCountries: ["DK"],
        isPayOutAllowed: true,
        minAmountForPayOut: 69,
        maxAmountForPayOut: 172110,
        defaultAmountForPayOut: 3450,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
  ...
  {
    symbol: "NZD",
    supportingCountries: ["NZ", "CK", "NU", "PN", "TK"],
    logoSymbol: "NZ",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 550,
        isConverted: true,
        visaPayoutCountries: ["CK", "NZ"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 18,
        maxAmountForPayOut: 43794,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 6100,
        isConverted: true,
        visaPayoutCountries: ["MX"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 203,
        maxAmountForPayOut: 506679,
        defaultAmountForPayOut: 10150,
      },
      {
        name: "AstroPay",
        id: "pm_astropay",
  ...
  {
    symbol: "AUD",
    supportingCountries: ["AU", "CX", "CC", "HM", "KI", "NR", "NF", "TV"],
    logoSymbol: "AU",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 500,
        isConverted: true,
        visaPayoutCountries: ["KI", "AU"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 16,
        maxAmountForPayOut: 39679,
    ...
    paymentOptions: [
      {
        ...
        minAmount: 5325,
        displayMessage: "",
        defaultAmount: 319450,
        isConverted: true,
        visaPayoutCountries: ["AR"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 10649,
        maxAmountForPayOut: 26622526,
        defaultAmountForPayOut: 532450,
      },
      {
        name: "AstroPay",
        id: "pm_astropay",
        ...
        minAmount: 31947,
        isBillingAddressRequired: true,
        supportedCountryCode: ["AR"],
        displayMessage: "",
        defaultAmount: 106500,
        isConverted: true,
        isPayOutAllowed: false,
        minAmountForPayOut: 10649,
        maxAmountForPayOut: 26622526,
    ...
    paymentOptions: [
      {
        ...
        minAmount: 174,
        isBillingAddressRequired: true,
        supportedCountryCode: ["BR"],
        isActive: true,
        defaultAmount: 600,
        isConverted: true,
        isPayOutAllowed: false,
        minAmountForPayOut: 58,
        maxAmountForPayOut: 144690,
        defaultAmountForPayOut: 2900,
      },
      {
        name: "Card Payment",
        id: "credit_debit_card",
    ...
    paymentOptions: [
      {
        ...
        minAmount: 27831,
        isBillingAddressRequired: true,
        supportedCountryCode: ["CL"],
        isActive: true,
        defaultAmount: 92750,
        isConverted: true,
        isPayOutAllowed: false,
        minAmountForPayOut: 9277,
        maxAmountForPayOut: 23192221,
        defaultAmountForPayOut: 463850,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 2531,
        defaultAmount: 151900,
        isConverted: true,
        visaPayoutCountries: ["CR"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 5063,
        maxAmountForPayOut: 12656294,
        defaultAmountForPayOut: 253150,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 81500,
        defaultAmount: 4890000,
        isConverted: true,
        visaPayoutCountries: ["ID"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 162999,
        maxAmountForPayOut: 407498707,
        defaultAmountForPayOut: 8149950,
      },
      {
        name: "Google Pay",
        id: "google_pay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 1100,
        isConverted: true,
        visaPayoutCountries: ["IL"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 36,
        maxAmountForPayOut: 91028,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 44400,
        isConverted: true,
        visaPayoutCountries: ["JP"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 1480,
        maxAmountForPayOut: 3701125,
        defaultAmountForPayOut: 74000,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 1300,
        isConverted: true,
        visaPayoutCountries: ["MY"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 44,
        maxAmountForPayOut: 110363,
        defaultAmountForPayOut: 2200,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 39639,
        defaultAmount: 2378300,
        isConverted: true,
        visaPayoutCountries: ["PY"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 79277,
        maxAmountForPayOut: 198193345,
        defaultAmountForPayOut: 3963850,
      },
    ],
    isPopular: true,
    isAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 1100,
        isConverted: true,
        visaPayoutCountries: ["PE"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 37,
        maxAmountForPayOut: 91448,
        defaultAmountForPayOut: 1850,
      },
      {
        name: "AstroPay",
        id: "pm_astropay",
    ...
    paymentOptions: [
      {
        ...
        isConverted: true,
        isPayOutAllowed: false,
        minAmountForPayOut: 575,
        maxAmountForPayOut: 1437088,
        defaultAmountForPayOut: 28750,
      },
      {
        name: "Maya",
        id: "pm_paymaya",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 400,
        isConverted: true,
        visaPayoutCountries: ["SG"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 13,
        maxAmountForPayOut: 33273,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 700,
        isConverted: true,
        visaPayoutCountries: ["FJ"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 23,
        maxAmountForPayOut: 57420,
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 1836,
        defaultAmount: 110150,
        isConverted: true,
        visaPayoutCountries: ["HU"],
        mastercardPayoutCountries: ["HU"],
        isPayOutAllowed: true,
        minAmountForPayOut: 3672,
        maxAmountForPayOut: 9179618,
        defaultAmountForPayOut: 183600,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 38850,
        isConverted: true,
        visaPayoutCountries: ["KE"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 1296,
        maxAmountForPayOut: 3239052,
        defaultAmountForPayOut: 64800,
      },
      {
        name: "Google Pay",
        id: "google_pay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 5450,
        isConverted: true,
        visaPayoutCountries: ["MD"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 182,
        maxAmountForPayOut: 454298,
        defaultAmountForPayOut: 9100,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 6900,
        isConverted: true,
        visaPayoutCountries: ["CZ"],
        mastercardPayoutCountries: ["CZ"],
        isPayOutAllowed: true,
        minAmountForPayOut: 230,
        maxAmountForPayOut: 575518,
        defaultAmountForPayOut: 11500,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 40700,
        isConverted: true,
        visaPayoutCountries: ["IS"],
        mastercardPayoutCountries: ["IS"],
        isPayOutAllowed: true,
        minAmountForPayOut: 1357,
        maxAmountForPayOut: 3393623,
        defaultAmountForPayOut: 67850,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 1400,
        isConverted: true,
        visaPayoutCountries: ["RO"],
        mastercardPayoutCountries: ["RO"],
        isPayOutAllowed: true,
        minAmountForPayOut: 46,
        maxAmountForPayOut: 114815,
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 4573,
        defaultAmount: 274350,
        isConverted: true,
        visaPayoutCountries: ["AO"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 9145,
        maxAmountForPayOut: 22862500,
        defaultAmountForPayOut: 457250,
      },
      {
        name: "Google Pay",
        id: "google_pay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 600,
        isConverted: true,
        visaPayoutCountries: ["BZ"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 20,
        maxAmountForPayOut: 50277,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 400,
        isConverted: true,
        visaPayoutCountries: ["BN"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 13,
        maxAmountForPayOut: 33309,
        defaultAmountForPayOut: 650,
      },
    ],
    isPopular: true,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 53500,
        isConverted: true,
        visaPayoutCountries: ["DJ"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 1783,
        maxAmountForPayOut: 4457160,
        defaultAmountForPayOut: 89150,
      },
    ],
    isPopular: true,
    isAllowed: true,
  ...
  {
    symbol: "XCD",
    supportingCountries: ["DM", "GD", "KN", "LC", "VC"],
    logoSymbol: "DM",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 800,
        isConverted: true,
        visaPayoutCountries: ["LC", "VC", "KN", "DM", "GD", "AG", "AI"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 27,
        maxAmountForPayOut: 67564,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 850,
        isConverted: true,
        visaPayoutCountries: ["GE"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 28,
        maxAmountForPayOut: 69500,
        defaultAmountForPayOut: 1400,
      },
    ],
    isPopular: true,
    isAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 2300,
        isConverted: true,
        visaPayoutCountries: ["GT"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 77,
        maxAmountForPayOut: 193051,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 7700,
        isConverted: true,
        visaPayoutCountries: ["HN"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 256,
        maxAmountForPayOut: 640059,
        defaultAmountForPayOut: 12800,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 2456,
        defaultAmount: 147350,
        isConverted: true,
        visaPayoutCountries: ["KZ"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 4912,
        maxAmountForPayOut: 12279207,
        defaultAmountForPayOut: 245600,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 23448,
        defaultAmount: 1406900,
        isConverted: true,
        visaPayoutCountries: ["MG"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 46897,
        maxAmountForPayOut: 117242256,
        defaultAmountForPayOut: 2344850,
      },
    ],
    isPopular: true,
    isAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 8680,
        defaultAmount: 520800,
        isConverted: true,
        visaPayoutCountries: ["MW"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 17361,
        maxAmountForPayOut: 43401886,
        defaultAmountForPayOut: 868050,
      },
    ],
    isPopular: true,
    isAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 12000,
        isConverted: true,
        visaPayoutCountries: ["MR"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 399,
        maxAmountForPayOut: 998454,
        defaultAmountForPayOut: 19950,
      },
    ],
    isPopular: true,
    isAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 1250,
        isConverted: true,
        visaPayoutCountries: ["PG"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 41,
        maxAmountForPayOut: 102201,
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 7048,
        defaultAmount: 422900,
        isConverted: true,
        visaPayoutCountries: ["RW"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 14097,
        maxAmountForPayOut: 35241986,
        defaultAmountForPayOut: 704850,
      },
    ],
    isPopular: true,
    isAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 2550,
        isConverted: true,
        visaPayoutCountries: ["SB"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 84,
        maxAmountForPayOut: 211004,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 10750,
        isConverted: true,
        visaPayoutCountries: ["SR"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 358,
        maxAmountForPayOut: 895000,
        defaultAmountForPayOut: 17900,
      },
    ],
    isPopular: true,
    isAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 5450,
        isConverted: true,
        visaPayoutCountries: ["SZ"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 181,
        maxAmountForPayOut: 453560,
        defaultAmountForPayOut: 9050,
      },
    ],
    isPopular: true,
    isAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 3250,
        isConverted: true,
        visaPayoutCountries: ["TJ"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 109,
        maxAmountForPayOut: 272828,
        defaultAmountForPayOut: 5450,
      },
    ],
    isPopular: true,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 1050,
        isConverted: true,
        visaPayoutCountries: ["TM"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 35,
        maxAmountForPayOut: 87750,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 12700,
        isConverted: true,
        visaPayoutCountries: ["UY"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 424,
        maxAmountForPayOut: 1060140,
        defaultAmountForPayOut: 21200,
      },
      {
        name: "AstroPay",
        id: "pm_astropay",
    ...
    paymentOptions: [
      {
        ...
        minAmount: 123195,
        isBillingAddressRequired: true,
        supportedCountryCode: ["CO"],
        isActive: true,
        defaultAmount: 821300,
        isConverted: true,
      },
      {
        name: "Card Payment",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 4650,
        isConverted: true,
        visaPayoutCountries: ["GH"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 155,
        maxAmountForPayOut: 387971,
        defaultAmountForPayOut: 7750,
      },
    ],
    roundOff: 2,
    isPayOutAllowed: true,
  ...
  },
  {
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 1100,
        isConverted: true,
        visaPayoutCountries: ["AE"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 37,
        maxAmountForPayOut: 91818,
        defaultAmountForPayOut: 1850,
      },
      {
        name: "Apple Pay",
    ...
    roundOff: 2,
    isPayOutAllowed: true,
    icon: '<svg width="90" height="64" viewBox="0 0 90 64" fill="none" xmlns="http://www.w3.org/2000/svg">\n <g clip-path="url(#clip0_3_23)">\n <path d="M90 0H1V64H90V0Z" fill="#00732F"/>\n <path d="M90 21H0V64H90V21Z" fill="white"/>\n <path d="M90 43H0V64H90V43Z" fill="black"/>\n <path d="M22 0H0V64H22V0Z" fill="#FF0000"/>\n </g>\n <defs>\n <clipPath id="clip0_3_23">\n <rect width="90" height="64" fill="white"/>\n </clipPath>\n </defs>\n </svg>',
  },
  {
    symbol: "KHR",
    supportingCountries: ["KH"],
    logoSymbol: "KH",
    name: "Cambodian Riel",
    isPopular: false,
    isAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 20062,
        defaultAmount: 1203700,
        isConverted: true,
        visaPayoutCountries: ["KH"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 40123,
        maxAmountForPayOut: 100308421,
        defaultAmountForPayOut: 2006150,
      },
    ],
    roundOff: 2,
    isPayOutAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 32400,
        isConverted: true,
        visaPayoutCountries: ["RS"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 1081,
        maxAmountForPayOut: 2701518,
        defaultAmountForPayOut: 54050,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 100,
        isConverted: true,
        visaPayoutCountries: ["BH"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 4,
        maxAmountForPayOut: 9424,
        defaultAmountForPayOut: 200,
      },
      {
        name: "Apple Pay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 17050,
        isConverted: true,
        visaPayoutCountries: ["MK"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 568,
        maxAmountForPayOut: 1419624,
        defaultAmountForPayOut: 28400,
      },
    ],
    roundOff: 2,
    isPayOutAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 100,
        isConverted: true,
        visaPayoutCountries: ["KW"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 3,
        maxAmountForPayOut: 7702,
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 1973,
        defaultAmount: 118350,
        isConverted: true,
        visaPayoutCountries: ["AM"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 3945,
        maxAmountForPayOut: 9862509,
        defaultAmountForPayOut: 197250,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 550,
        isConverted: true,
        visaPayoutCountries: ["CW", "AW"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 18,
        maxAmountForPayOut: 45111,
        defaultAmountForPayOut: 900,
      },
    ],
    roundOff: 2,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 250,
        isConverted: true,
        visaPayoutCountries: ["KY"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 8,
        maxAmountForPayOut: 20858,
        defaultAmountForPayOut: 400,
      },
    ],
    roundOff: 2,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 30550,
        isConverted: true,
        visaPayoutCountries: ["CV"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 1018,
        maxAmountForPayOut: 2543833,
        defaultAmountForPayOut: 50900,
      },
    ],
    roundOff: 2,
    isPayOutAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 550,
        isConverted: true,
        visaPayoutCountries: ["BA"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 18,
        maxAmountForPayOut: 45121,
        defaultAmountForPayOut: 900,
      },
    ],
    roundOff: 2,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 200,
        isConverted: true,
        visaPayoutCountries: ["PS"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 7,
        maxAmountForPayOut: 17735,
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 2050,
        isConverted: true,
        visaPayoutCountries: ["TT"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 68,
        maxAmountForPayOut: 169912,
